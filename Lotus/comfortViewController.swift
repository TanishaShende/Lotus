...
class comfortViewController: UIViewController {
    ...
    let hopelessWords = ["You're not alone.", "I know; it's terrifying. I hope you can find some small beauty in this world.", "Check out David Byrne's Reasons to Be Happy", "Try to believe that you won't feel like this forever.", "I get it. Whatever you can do is enough.", "I hope you can rest soon."]
